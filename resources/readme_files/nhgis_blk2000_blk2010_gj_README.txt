--------------------------------------------------------------------------------
Documentation for nhgis_blk2000_blk2010_gj.csv
NHGIS crosswalk from 2000 to 2010 census blocks with GISJOIN identifiers
--------------------------------------------------------------------------------
...
File name:  nhgis_blk2000_blk2010_gj.csv
Content:
	- The top row is a header row
	- Each subsequent row represents an intersection between a 2000 block and 2010 block
	- The GJOIN2000 and GJOIN2010 fields contain NHGIS-standard GISJOIN block identifiers:
